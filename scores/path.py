...
def score_actuator_saturation(vp, sts, acts, vlm, task, nom, *, threshold_deg: float = 10):
    """
    ...
    # - 0% saturation → score = 1.0
    # - 50% saturation → score ≈ 0.14
    # - 100% saturation → score ≈ 0.0
